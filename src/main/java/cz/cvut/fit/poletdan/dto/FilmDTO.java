...
public class FilmDTO {
    ...
    public FilmDTO(String name, String country, String genre, String motto, String producer, String screenwriter, String operator, String composer, String budget, String box_office, String DVD_release, String duration, String picture_url, String youtube_video_id, String description, double rating, String year) {
        this.name = name;
